...
export default class extends Controller {
  ...
  loadTranscript() {
    ...
    transcriptContainer.innerHTML = `
      <div class="flex items-center justify-center py-4">
        <svg class="animate-spin h-6 w-6 text-emerald-600 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  formatArrayTranscript(segments) {
    ...
    segments.forEach((segment, index) => {
      ...
      const bgColor = speaker === 'Customer' ? 'bg-emerald-50' : 'bg-green-50'
