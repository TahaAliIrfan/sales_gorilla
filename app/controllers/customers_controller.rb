class CustomersController < ApplicationController
  ...
  before_action :set_customer, only: [ :show, :edit, :update, :destroy, :update_status, :update_communication_status, :analyze_phone, :calculate_lead_score, :assign_to_self, :upload_documents, :mark_lead_quality, :add_note, :enrich ]
