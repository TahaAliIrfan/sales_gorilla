class TwilioService
  ...
  def generate_voice_response(phone_number, caller_id = nil)
    caller_id ||= @default_caller_id
    
    Twilio::TwiML::VoiceResponse.new do |r|
      if phone_number
        r.dial(caller_id: caller_id, record: 'record-from-answer',
               recording_status_callback: "#{base_url}/calling/recording_status") do |d|
